...
public class CustomerTest {
	...
	public void shouldHaveRegularRentalStatementWithRegularRentals() {
		...
		c.addRental(new Rental(new Movie("M1", Movie.REGULAR), 1));
	...
	public void shouldHaveRegularRentalStatementWithLongRegularRentals() {
		...
		c.addRental(new Rental(new Movie("M1", Movie.REGULAR), 3));
	...
	public void shouldHaveNewReleaseRentalStatementWithNewReleaseRentals() {
		...
		c.addRental(new Rental(new Movie("M1", Movie.NEW_RELEASE), 1));
	...
	public void shouldAddExtraFrequentRenterPointsForNewReleaseRentalStatementWithForLongNewReleaseRentals() {
		...
		c.addRental(new Rental(new Movie("M1", Movie.NEW_RELEASE), 3));
	...
	public void shouldHaveChildrenRentalStatementWithChildrenRentals() {
		...
		c.addRental(new Rental(new Movie("M1", Movie.CHILDRENS), 1));
	...
	public void shouldHaveChildrenRentalStatementWithLongChildrenRentals() {
		...
		c.addRental(new Rental(new Movie("M1", Movie.CHILDRENS), 4));
	...
	public void shouldAddMultipleMovieRentalToStatement(){
		...
		c.addRental(new Rental(new Movie("M1", Movie.REGULAR), 4));
		c.addRental(new Rental(new Movie("M2", Movie.NEW_RELEASE), 5));
		c.addRental(new Rental(new Movie("M3", Movie.CHILDRENS), 6));
		c.addRental(new Rental(new Movie("M4", Movie.NEW_RELEASE), 7));
	...
	public void shouldHaveZeroRentalStatementWithWrongTypeRentals() {
		...
		try {
			c.addRental(new Rental(new Movie("M1", 4), 1));
		} 
